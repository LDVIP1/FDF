...
def chk():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[91mBarezm Id kat active nya Tkaya bo Active krdn nama bnera bo telegram @ssfgss")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
\33[1;33m█▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█
\33[1;33m█  \33[mGithub: 
\33[1;33m█  \33[mFacebook: 
\33[1;33m█  \33[mWhatsApp: 1762445
\33[1;33m█  \33[mTools : \33[1;33m
\33[1;33m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
"""%(h))
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [SAHD] %s/%s ~_~ [OK:%s] ^_^ [CP:%s] ~_~ %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
